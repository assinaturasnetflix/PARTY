...
// A variável CLOUDINARY_URL já contém tudo (api_key, api_secret, cloud_name)
cloudinary.config({
    cloud_name: 'dje6f5k5u',
    api_key: '244116312579825',
    api_secret: 'wjVJ9-Jh0QHPBuPzi8pVLNBPCoI',
  });
...
const videoStorage = new CloudinaryStorage({
    ...
    params: {
        ...
        // Eager transformations podem ser adicionadas para criar versões de qualidade diferente na hora do upload
        // eager: [
...
// Cria um "transporter" reutilizável com as credenciais do Gmail
 ...
 * @param {object} mailOptions - Opções para o e-mail (to, subject, html).
 */
const sendEmail = async (mailOptions) => {
    try {
        ...
        // Em um app de produção, você pode querer um sistema de fallback ou retry.
    }
};

/**
 * Cria o corpo HTML para o e-mail de boas-vindas.
...
/**
 * Cria o corpo HTML para o e-mail de recuperação de senha.
 * @param {string} resetURL - A URL com o token para redefinir a senha.
 * @returns {string} - HTML do e-mail.
 */
